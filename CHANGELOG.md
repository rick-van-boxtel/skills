...
- [`341d589`](https://github.com/mattpocock/skills/commit/341d589ac6adee93dcf6fef1affc22bddebbb285) Thanks [@rick-van-boxtel](https://github.com/rick-van-boxtel)! - Make issue work types and readiness states repository-configurable, with a first-class Linear template and workflow contract.
...
- [`629dcb9`](https://github.com/mattpocock/skills/commit/629dcb923a4e9370af3d1e6d8db8c30a913a0da4) Thanks [@rick-van-boxtel](https://github.com/rick-van-boxtel)! - Review uncommitted work truthfully, follow repository reviewer policy, allow immediate TDD refactoring, and make debugging evidence-led. Preserve paired instruction routes and existing workflow configuration during setup.
